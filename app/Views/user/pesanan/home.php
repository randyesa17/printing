                ...
                <table class="table align-items-center table-flush">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td><?= $value['jumlah'] ?></td>
                            <td class="budget" colspan="2">Rp. <?= number_format($value['totalharga']) ?></td>
                            ...
                            <td class="text-right">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        <a class="dropdown-item"
                                            href="<?= site_url('user/pesanan/detail?idtransaksi='.$value['idtransaksi']) ?>">Detail</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="budget"><?= $value['idgroup'] ?></td>
                            <td class="budget">Rp. <?= number_format($value['ongkir']) ?></td>
                            <td class="budget">Rp. <?= number_format($value['totalbiaya']) ?></td>
                            <td><?= $value['status'] ?></td>
                            <td class="text-right" rowspan="">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <?php if($value['status'] == 'Belum Bayar') : ?>
                                        <a class="dropdown-item"
                                            href="<?= site_url('user/pesanan/bayars?idgroup='.$value['idgroup']) ?>">Bayar</a>
                                        <?php elseif($value['status'] == 'Dikirim') : ?>
                                        <a class="dropdown-item"
                                            href="<?= site_url('user/pesanan/terimas?idgroup='.$value['idgroup']) ?>">Diterima</a>
                                        <?php elseif($value['status'] != 'Belum Bayar') : ?>
                                        <a class="dropdown-item"
                                            href="<?= site_url('user/pesanan/details?idgroup='.$value['idgroup']) ?>">Detail</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
