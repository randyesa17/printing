...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo"><a href="<?= site_url() ?>"><img src="<?= site_url('assets/publik/img/logo.jpg') ?>"
                        alt=""></a></h1>
            ...
            <nav class="nav-menu d-none d-lg-block">
                ...
                <ul>
                    ...
                    <li><a href="<?= site_url('cara') ?>">Cara Pesan</a></li>
            ...
            <a href="<?= site_url('user/login') ?>" class="get-started-btn ml-auto">Masuk</a>
